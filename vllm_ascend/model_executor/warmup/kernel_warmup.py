...
from vllm_ascend.model_executor.warmup.rwkv7_triton_warmup import (
    model_uses_rwkv7,
    rwkv7_triton_warmup,
)
...
def kernel_warmup(worker: NPUWorker) -> None:
    ...
    if model_uses_rwkv7(worker.vllm_config.model_config):
        _run_warmup("rwkv7", rwkv7_triton_warmup, worker)
